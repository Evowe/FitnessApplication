...
public class WorkoutLogDBTest {
    ...
    @BeforeEach
    public void setUp() {
        WorkoutLogDB = DatabaseManager.getWorkoutLogDB();
    }
    ...
    public void tearDown() throws SQLException {
        ...
        try {
            conn = WorkoutLogDB.getConnection();
    ...
    public void testDeleteWorkout() throws SQLException {
        ...
        boolean deleted = WorkoutLogDB.deleteWorkout(a.getUsername(),name);
        assertTrue(deleted, "Workout should be deleted successfully");

        Workout retrievedWorkout = WorkoutLogDB.getWorkout(a.getUsername(),name);
    ...
    public void testUpdateWorkout() throws SQLException
    {
        ...
        assertTrue(b);
        Workout retrievedWorkout = WorkoutLogDB.getWorkout(a.getUsername(),name2);
        assertNotNull(retrievedWorkout);
